...
(:file:`/etc/php8.3/fpm/php-fpm.conf`) and they are prioritized over those
defined in :file:`/etc/php/8.3/fpm/php.ini`. Be aware that multiple configuration
...
version and installation method, but typically for PHP 8.3, you can find this 
file at ``/etc/php/8.3/fpm/pool.d/atom.conf``.  
