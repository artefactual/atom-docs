...
In `Dominion <https://github.com/artefactual/atom/tree/qa/2.4.x/plugins/arDominionPlugin>`_,
...
`arArchivesCanadaPlugin <https://github.com/artefactual/atom/tree/qa/2.4.x/plugins/arArchivesCanadaPlugin>`_.
