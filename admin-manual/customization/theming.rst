...
In `Dominion <https://github.com/artefactual/atom/tree/stable/2.3.x/plugins/arDominionPlugin>`_,
...
`arArchivesCanadaPlugin <https://github.com/artefactual/atom/tree/stable/2.3.x/plugins/arArchivesCanadaPlugin>`_.
