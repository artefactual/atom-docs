...
+---------------------------------+--------------------------------------------+
| CsvIOTitleLengthValidator       | Archival description                       |
+---------------------------------+--------------------------------------------+
| CsvAccessionTitleLengthValidator| Accession                                  |
+---------------------------------+--------------------------------------------+
| CsvEventDateValidator           | Archival description                       |
+---------------------------------+--------------------------------------------+
...
* :ref:`csv-validation-language-io`
* :ref:`csv-validation-scriptdesc`
* :ref:`csv-validation-io-title`
* :ref:`csv-validation-eventdate`
...
.. _csv-validation-io-title:

Title Length Check (archival description)
-----------------------------------------
...
* **Test class:** CsvEventDateValidator

This test will attempt to validate the values used in the ``eventStartDates``
and ``eventEndDates`` columns of an :term:`archival description` CSV
for the following date formats:
...
.. code-block:: none
   ...
   WARNING 15 - Event Date Check
   ---------------------------

   Rows with invalid event date values: 1
   CSV row numbers where issues were found: 4
   Listing invalid date values: "2005-?"

.. _csv-validation-eventdate-output:
...
This section describes supplementary tests that are run when an
:term:`accession` import CSV is submitted for validation, in
addition to the :ref:`general validation tests <csv-validation-all>` run
for all :term:`entity` types.

**Jump to:**

* :ref:`csv-validation-accession-title`

.. _csv-validation-accession-title:

Title Length Check (accession)
------------------------------
